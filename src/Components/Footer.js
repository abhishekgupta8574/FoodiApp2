    ...
    <div>
        ...
        <div className=" lg:w-3/12 w-4/12 md:w-3/12 ">
          <div className="flex justify-center items-center flex-col gap-2">
            ...
            <div className="flex justify-evenly md:gap-4 gap-3 lg:gap-5 items-center flex-row">
              <Link
                target="_blank"
                to={"https://www.instagram.com/vickygupta011294/"}
              >
                <span className="text-white lg:text-2xl text-xl md:text-2xl">
                  <i className="ri-instagram-line"></i>
                </span>
              </Link>
              <Link target="_blank" to={"https://github.com/abhishekgupta8574"}>
                <span className="text-white lg:text-2xl text-xl md:text-2xl">
              ...
              <Link
                target="_blank"
                to={"https://www.linkedin.com/in/abhishek-gupta-2406a2242/"}
              >
                <span className="text-white lg:text-2xl text-xl md:text-2xl">
                  <i className="ri-linkedin-box-fill"></i>
                </span>
              </Link>
              <Link target="_blank" to={"https://twitter.com/VickyVg6846119"}>
                <span className="text-white lg:text-2xl text-xl md:text-2xl">
      ...
      <div className="bg-zinc-800 text-white text-center py-5">
        <span className="tracking-wide">
          © 2023 All Rights Reserved Abhishek Gupta "Vicky"
        </span>
      </div>
    </div>
  );
