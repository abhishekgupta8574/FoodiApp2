      ...
      <div className="border-spacing-1 border rounded-md w-full relative overflow-hidden">
        ...
        {product_description && (
          <div className="absolute top-[-24] left-[-2] ">
            <img
              className="w-8"
              src="https://thingproxy-760k.onrender.com/fetch/https://instamart-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_64,h_108/instamart-assets/offer_tag.png"
            ></img>
